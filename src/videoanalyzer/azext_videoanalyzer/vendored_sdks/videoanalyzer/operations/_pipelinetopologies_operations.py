...
class pipelinetopologiesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.pipelinetopologycollection"]
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.pipelinetopologycollection"]
        error_map = {
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.pipelinetopology"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def create_or_update(
        ...
        account_name,  # type: str
        pipeline_topology_name,  # type: str
        parameters,  # type: "models.pipelinetopology"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.pipelinetopology"
    ...
    def update(
        ...
        account_name,  # type: str
        pipeline_topology_name,  # type: str
        parameters,  # type: "models.pipelinetopologyupdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.pipelinetopology"
