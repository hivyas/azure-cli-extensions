...
class livepipelinesOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.livepipelinecollection"]
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.livepipelinecollection"]
        error_map = {
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.livepipeline"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def create_or_update(
        ...
        account_name,  # type: str
        live_pipeline_name,  # type: str
        parameters,  # type: "models.livepipeline"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.livepipeline"
    ...
    def update(
        ...
        account_name,  # type: str
        live_pipeline_name,  # type: str
        parameters,  # type: "models.livepipelineupdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.livepipeline"
