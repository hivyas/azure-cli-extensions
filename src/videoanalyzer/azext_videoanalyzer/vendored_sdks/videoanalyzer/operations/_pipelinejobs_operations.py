...
class pipelinejobsOperations(object):
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> Iterable["models.pipelinejobcollection"]
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.pipelinejobcollection"]
        error_map = {
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        :raises: ~azure.core.exceptions.HttpResponseError
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.pipelinejob"]
        error_map = {
            401: ClientAuthenticationError, 404: ResourceNotFoundError, 409: ResourceExistsError
        }
        error_map.update(kwargs.pop('error_map', {}))
    ...
    def create_or_update(
        ...
        account_name,  # type: str
        pipeline_job_name,  # type: str
        parameters,  # type: "models.pipelinejob"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.pipelinejob"
    ...
    def update(
        ...
        account_name,  # type: str
        pipeline_job_name,  # type: str
        parameters,  # type: "models.pipelinejobupdate"
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.pipelinejob"
