...
class livepipelineoperationstatusesOperations(object):
    ...
    def get(
        ...
        **kwargs  # type: Any
        ...
        # type: (...) -> "models.livepipelineoperationstatus"
        ...
        """
        cls = kwargs.pop('cls', None)  # type: ClsType["models.livepipelineoperationstatus"]
        error_map = {
